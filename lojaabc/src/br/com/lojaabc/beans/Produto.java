...
public class Produto {
	...
	public void atualizarValores(float porcentagem) {
		...
		//setValorVenda(getValorVenda() + getValorVenda() * (porcentagem/100)); => usando somente método
	}
	...
	public String verificarEstoque() {
		...
		return "Estoque normal"; // return null ou return " " também podem ser utilizados 
	}
